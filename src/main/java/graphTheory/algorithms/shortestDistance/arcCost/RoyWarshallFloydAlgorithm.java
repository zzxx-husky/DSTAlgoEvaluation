...
public class RoyWarshallFloydAlgorithm extends Algorithm<ArcShortestPathsInstance> {
     ...
     * from u to v
     */
    protected HashMap<Couple<Integer, Integer>, Double> costs;

    public HashMap<Couple<Integer, Integer>, LinkedList<Arc>> getShortestPaths() {
        return shPs;
    }

    public HashMap<Couple<Integer, Integer>, Double> getCosts() {
        return costs;
    }
    ...
    protected void computeWithoutTime() {
        HashMap<Couple<Integer, Integer>, Double> csts = new HashMap<Couple<Integer, Integer>, Double>();
     ...
     */
    private void init(HashMap<Couple<Integer, Integer>, Double> costs,
        ...
        while (it.hasNext()) {
            ...
            double omega = instance.getDoubleCost(a);
            Double c_om = costs.get(c);
     ...
     */
    private void update(HashMap<Couple<Integer, Integer>, Double> cst,
        ...
        c1.first = v;
        c1.second = u;
        Double vu = cst.get(c1);

        c2.first = u;
        c2.second = w;
        Double uw = cst.get(c2);

        c3.first = v;
        c3.second = w;
        Double vw = cst.get(c3);
